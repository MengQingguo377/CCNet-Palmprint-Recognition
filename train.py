...
'''
python train.py --id_num 600 --train_set_file ./data/train_Tongji.txt --test_set_file ./CCNet/data/test_Tongji.txt --des_path ./output/checkpoint/ --path_rst ./output/result/
'''